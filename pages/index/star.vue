<template>
	<div class="container">
		...
		<div class="content">
			<p class="p">亲爱的！</p>
			<br>
			<p>很久没有给人写过信了，而且还是情书，手可能有点生疏，哈哈哈！</p>
			<p>突然不知道该怎样开口，更不知道该怎样下笔，奈何好久不练字，就怕拿到手写的笔记后，你也认不得；</p>
			<p>从我两相识而来，到现在已经快半年了，时间过的可真快，这半年来，我从未停止过向你表达过我的心意。但是没有笔墨和文件的记载，仅凭当时的话语，恐怕以你的小脑瓜，早就忘得一干二净了吧；</p>
			<p>思来想去，还是觉得需要以字体书信的方式来寄托我的情思。</p>
			<p>我俩相识对我而言如同梦幻一般，在我已经不在盼望能遇到我理想中的她时；奇迹般的遇见了你。刚见到你的时候，因为我的心态问题，虽说没有年轻人口中说的一见钟情般的感受。但令人欣喜的是，你带给我柔和般的感受；
				如同鱼儿遇见了水，怡然自得和舒适；就像是多年不见的老友般情切，自燃，舒适；后来我才想明白，其实这去一切那是源于你的温柔和温婉。即使如此我也有报太大的希望，能让你喜欢我。直到你的那个吻，又让我有希望和勇气再去喜欢一个人；
				我想我是掉进了你的陷阱，以至于到现在也无法逃离。
				就如同歌中所唱“轻轻的一个吻，已经打动我的心；深深的一段情，让我思念到如今...”。多希望的陷阱能坚若磐石，能锁住一人一辈子</p>
			<p>一直以来对于感情中有个问题一直困扰着我，即使两个人刚开始不管爱的究竟有多深，哪怕如此情真意切，感天动地，至死不渝；但是都逃不了现实生活的洗礼和摧残；时间一久，大家终会要为了现实生活问题争执，吵架
				。到那时候，当初越是美好的爱情，就会越痛心；以往的经历让我也不知是不是该那样做；主要是不想让你以后会体会到那种滋味，我害怕你心碎时没人帮你擦眼泪；可是我们都不再是刚二十出头的年轻人，血气方刚，精力充沛；
				认定一个人后，发誓也坚定认为能给她想要的幸福；或许是我们更加现实了，更加迷茫了，我只能说我会用一生来实现我想要给你的幸福。但是我们心里都清楚，天真终究敌不过现实；我也保证不了一定能够做到；说这话并不是代表
				我不会去爱你了，只是我不想骗你也不想骗自己；不想你以后因为我而失望，失落和难过。
			</p>
			<uni-row class="demo-uni-row" style="text-align: center; font-family: cursive;color: #cddc39;line-height:24px;">
				<uni-col :span="12">
					<image src="@/static/img/one.jpg" mode="" id="one"></image>
				</uni-col>
				<uni-col :span="12">
					<h3>------------</h3>
					<h3>喜欢在人潮中 <br>你只属于我的那画面</h3>
					<h3>可以在安静中<br>静静地欣赏你那张脸</h3>
					<h3>许下那<br>风都无法侵蚀的誓言</h3>
				</uni-col>
			</uni-row>
			<p>
				也许我做不到，成不了那般轰轰烈烈的爱情故事，但是守护你，保护你；是我不变的初心，也是我未来几十年最主要的目标；希望们都能不忘初心，彼此相爱到永远；
			</p>
			<uni-row class="demo-uni-row" style="text-align: center; font-family: cursive;color: #cddc39;line-height:24px;">
				<uni-col :span="12">
					<h3>------------</h3>
				...
				<uni-col :span="12">
					<image src="@/static/img/two.jpg" mode="" id="two"></image>
				</uni-col>
			</uni-row>
			<br>
			<br>
	...
	export default {
		...
		methods: {
			init() {
				...
				// var canva = uni.createCanvasContext('universe');
				var stars = [];
				...
				function Star() {
					...
					this.draw = function() {
						...
						if (this.giant) {
							...
							//comet tail
							for (var i = 0; i < 30; i++) {
								universe.fillStyle = 'rgba(' + cometColor + ',' + (this.opacity - (this.opacity / 20) *
									i) + ')';
				...
				var Clock = (function() {
					var canvas,
						...
						press = false,
						quiver = true,
						texts = ["蔚蓝星空下", "男孩独自坐望", "星海闪烁", "仿佛在问", "为什么你一个人", "我在等一个人", "一个女孩", "这个女孩", "真没什么好的",
							"性格很倔强", "脾气又不好", "还很强势", "但男孩觉得", "这都是表面", "在他的眼中", "女孩任性起来", "耍起混来的时候", "真的很可爱",
							"可是", "就是这样的她", "也非常的脆弱", "也有", "伤心难过的时候", "而男孩", "看着她", "想要做一千件事", "让她开心起来", "却总是放下",
							"已经攥紧的拳头", "空荡荡", "因为男孩知道", "女孩心中有个人", "那是一座女孩", "筑起的城堡", "男孩走不近", "只能呆呆望着", "其实他也知道",
							"这样很傻", "但是放下", "却做不到", "在城堡外", "继续等待", "男孩再次抬头", "望向星空", "嘿", "女孩", "我能成为", "你的星星吗",
							"小小的星光", "不过分炙热", "不会灼伤你", "让你耍赖", "给你依赖", "给你幸福", "等待着你", "Always"
						],
					...
					var setGradient = function(gradientStops) {
						...
						gradient = ctx.createRadialGradient(width / 2, height / 2, 0, width / 2, height / 2,
							width);
					...
					return {
						init: function(canvasID) {
							...
							canvas = uni.createCanvasContext(canvasID);
...
<style>
	...
	.container {
		...
		background-image: radial-gradient(1600px at 70% 120%, rgb(156 167 241) 10%, #698de9 100%);
