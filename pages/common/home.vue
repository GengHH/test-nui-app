<template>
	<view class="flex-container">
		<!-- <web-view :webview-styles="webviewStyles" src="https://static-6294bbe6-5207-4f48-a030-98219bdba3b7.bspapp.com">
		</web-view> -->
		<!-- <music></music> -->
		<uni-row class="unit">
			<!-- <div class="unit"> -->
		...
		<uni-row class="svg">
			<svg version="1.1" id="L2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
				...
				<circle fill="none" stroke="#ffffff60" stroke-width="4" stroke-miterlimit="10" cx="50" cy="50" r="48" />
				<line fill="none" stroke-linecap="round" stroke="#ffffff60" stroke-width="4" stroke-miterlimit="10" x1="50"
					y1="50" x2="85" y2="50.5">
...
<style>
	...
	.tip {
		animation: tip 1.5s linear infinite;
	}
